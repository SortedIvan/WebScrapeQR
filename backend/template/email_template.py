...
def CreateHtmlForProperty(property):
    ...
    property_string = f"""
                    <div style="border: 1px solid #ccc; padding: 10px; margin: 10px auto; box-shadow: 2px 2px 8px #ccc; border-radius: 5px; background-color: #f5f5f5; width: 600px; text-align:center;">
                        ...
                        <h3 style="margin: 5px 0; font-size: 14px;>{property.listingAdress}</h3>
                        <p style="margin: 5px 0; font-size: 14px;>{property.listingCity}</p>
                        <p style="margin: 5px 0; font-size: 14px;>{property.listingPrice}</p>
                        <p style="margin: 5px 0; font-size: 14px;>{property.listingSqm} sqm</p>
